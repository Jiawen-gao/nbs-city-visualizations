...
const data: {
...
}[] = [
  {
    ...
    cityData: {
      emissions: {
        perYear: { stockholm: 0.93, vienna: 0.56, madrid: 1.58, barcelona: 1.2 },
        reductionShare: { stockholm: '23.5%', vienna: '5.0%', madrid: '9.7%', barcelona: '12.0%' },
      },
      effectsPerUnit: {
        area: 1,
        lower: { stockholm: 0.5, vienna: 0.3, madrid: 0.2, barcelona: 0.8 },
        upper: { stockholm: 3.6, vienna: 2.4, madrid: 4.3, barcelona: 4.3 },
      },
    },
  },
  {
    ...
    cityData: {
      emissions: {
        perYear: { stockholm: 0.34, vienna: 0.71, madrid: 0.43, barcelona: 0.5 },
        reductionShare: { stockholm: '8.5%', vienna: '6.3%', madrid: '2.7%', barcelona: '3.0%' },
      },
      effectsPerUnit: {
        area: 10,
        lower: { stockholm: 0.05, vienna: 0.1, madrid: 0.08, barcelona: 0.1},
        upper: { stockholm: 1.2, vienna: 2.8, madrid: 1.5, barcelona: 1.5},
      },
    },
  },
  {
    ...
    cityData: {
      emissions: {
        perYear: { stockholm: 0.79, vienna: 1.09, madrid: 1.93, barcelona: 1.2 },
        reductionShare: { stockholm: '19.8%', vienna: '9.7%', madrid: '11.8%', barcelona: '12.0%' },
      },
      effectsPerUnit: {
        area: 1,
        lower: { stockholm: 0.2, vienna: 0.3, madrid: 0.5, barcelona: 0.5 },
        upper: { stockholm: 1.3, vienna: 4.0, madrid: 5.6, barcelona: 3.2},
      },
    },
  },
  {
    ...
    cityData: {
      emissions: {
        perYear: { stockholm: 0.3, vienna: 0.92, madrid: 1.27, barcelona: 1.2 },
        reductionShare: { stockholm: '7.6%', vienna: '8.2%', madrid: '7.8%', barcelona: '8.0%' },
      },
      effectsPerUnit: {
        area: 1,
        lower: { stockholm: 0.1, vienna: 0.5, madrid: 0.2, barcelona: 1.2 },
        upper: { stockholm: 1.8, vienna: 3.0, madrid: 4.0, barcelona: 4.5},
      },
    },
  },
  {
    ...
    cityData: {
      emissions: {
        perYear: { stockholm: 0.53, vienna: 1.41, madrid: 1.47, barcelona: 1.2 },
        reductionShare: { stockholm: '13.4%', vienna: '12.6%', madrid: '9.0%', barcelona: '10.0%' },
      },
      effectsPerUnit: {
        area: 1,
        lower: { stockholm: 0.2, vienna: 0.4, madrid: 0.1, barcelona: 0.9 },
        upper: { stockholm: 3.0, vienna: 4.5, madrid: 5.2, barcelona: 4.8},
      },
    },
  },
];
...
const cities: CitiesType[] = [
  ...
  },
  {
    ...
    value: 'barcelona',
    disabled: false,
    newView: { center: fromLonLat([2.1734, 41.3851]), zoom: 9 },
  }
];
